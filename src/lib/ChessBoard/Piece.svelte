<script lang="ts">
  ...
  import type { Piece, Maybe } from '../../scripts/chess'

  export let piece: Maybe<Piece> = null
...
{#if piece !== null}
  <img
    src={pieces[piece.color][piece.name]}
    alt="A {piece.color} {piece.name}"
    class="piece"
    data-color={piece.color}
    data-location={piece.location}
  />
{/if}
